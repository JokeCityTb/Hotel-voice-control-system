...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public DBHelper(Context context) {
         ...
         */
        super(context, "eningqu_meeting.db", null, 1);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table translatehistory(id integer primary key autoincrement, oldlanguage varchar(1000), tranlanguage varchar(1000),audiopath varchar(100),trantype integer,trandate varchar(20))");
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("alter table translatehistory add account varchar(20)");
    }
}
